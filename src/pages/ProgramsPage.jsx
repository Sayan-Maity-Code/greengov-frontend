    ...
    const handleConfirmApplication = async () => {
        ...
        try {
            ...
            if (response.status === 201 || response.status === 200) {
                ...
                setApplyingTo(null); // Hide the blue form
                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-md-6">
                                <p className="mb-1"><strong>Program ID:</strong> #{applyingTo.programId}</p>
                                        ...
                                        <tr key={p.programId}>
                                            ...
                                            <td className="text-end pe-4">
                                                <div className="d-flex gap-1 justify-content-end flex-nowrap">
                                                    ...
                                                    {/* --- CITIZEN VIEW: Updated to match your ROLE_CITIZEN data --- */}
                                                    {JSON.parse(localStorage.getItem("userData"))?.roles?.includes("ROLE_CITIZEN") && (
                                                        <button
